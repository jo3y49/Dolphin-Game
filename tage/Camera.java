...
public class Camera
{
	...
	public void yaw(float rotationSpeed)
	{
		...
		rightVector.rotateAxis(rotationSpeed, upVector.x(), upVector.y(), upVector.z());
		fwdVector.rotateAxis(rotationSpeed, upVector.x(), upVector.y(), upVector.z());
		setU(rightVector);
		setN(fwdVector);
	}
	...
	public void pitch(float pitchSpeed)
	{
		...
		Vector3f upVector = getV();
		Vector3f fwdVector = getN();
		upVector.rotateAxis(pitchSpeed, rightVector.x(), rightVector.y(), rightVector.z());
		fwdVector.rotateAxis(pitchSpeed, rightVector.x(), rightVector.y(), rightVector.z());
		setV(upVector);
		setN(fwdVector);
	}
